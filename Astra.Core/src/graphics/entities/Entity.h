...
namespace Astra::Graphics
{
	...
	public:
		...
		Entity(const VertexArray* vertArray, const ImageMaterial* material = new ImageMaterial(), int textureIndex = 0, const Math::Vec3& position = Math::Vec3(0), const Math::Vec3& rotation = Math::Vec3(0), const Math::Vec3& scale = Math::Vec3(1));
