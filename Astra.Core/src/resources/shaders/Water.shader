...
void main()
{
	...
	vec2 totalDistortion = (texture(dudvMap, distortedTexCoords).rg * 2.0 - 1.0) * waveStrength * clamp(waterDepth / 10.0, 0, 1);
	...
	refractiveFactor = pow(refractiveFactor, 0.9); // High - Higher reflectivity, Low - Lower reflectivity
