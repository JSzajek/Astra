...
int main()
{
    ...
    Texture* texture = Loader::LoadTexture("res/textures/test1.jpg");
    ...
    const VertexArray* vertArray2 = ObjLoader::LoadObjectModel("res/cube.obj");
    ...
    Texture* grassTexture = Loader::LoadTexture("res/textures/grass.jpg", GL_REPEAT);
